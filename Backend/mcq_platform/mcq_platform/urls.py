...
urlpatterns = [
    ...
    path("api/save-data", save_data,name = "saveData"),
    path("api/start-contest", start_contest, name="start_contest"),
    path("api/assessment/questions", save_question, name="save_question"),
    ...
    path("api/finish-contest", finish_contest,name="finish-contest"),
    path("api/bulk-upload",bulk_upload_questions,name="bulkUpload"),
]
